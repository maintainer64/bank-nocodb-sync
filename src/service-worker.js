...
const DNR_RULES = [
  ...
  {id: 2, urlFilter: '*.tbank.ru/*',          origin: 'https://www.tbank.ru'},
  {id: 3, urlFilter: 'bank.yandex.ru/*',      origin: 'https://bank.yandex.ru'},
  {id: 4, urlFilter: 'lavka.yandex.ru/*',     origin: 'https://lavka.yandex.ru'},
  {id: 5, urlFilter: 'api.lifemart.ru/*',     origin: 'https://lifemart.ru'},
];
